      ...
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-lg border border-white/10 shadow-2xl transition-all duration-300 hover:shadow-purple-500/20">
        ...
        <div className="relative p-6 z-10">
          ...
          <div className="mt-5 space-y-4">
            <h3 className="text-2xl font-semibold bg-gradient-to-r from-blue-200 via-purple-200 to-pink-200 bg-clip-text text-transparent">
              {Title}
            </h3>

            <p className="text-gray-300/80 text-base leading-relaxed line-clamp-2">
              {Description}
            </p>
            ...
            <div className="pt-4 flex items-center justify-between">
              {ProjectLink ? (
                ...
                <span className="text-gray-500 text-base">{t("Demo Not Available", "Démo non disponible")}</span>
              )}
              ...
              {id ? (
                ...
                <span className="text-gray-500 text-base">{t("Details Not Available", "Détails non disponibles")}</span>
              )}
            </div>
          </div>
